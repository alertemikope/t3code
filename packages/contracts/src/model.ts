...
const OCEAN_DRIVER_KIND = ProviderDriverKind.make("ocean");
...
> = {
  ...
  [OPENCODE_DRIVER_KIND]: "openai/gpt-5",
  [OCEAN_DRIVER_KIND]: "gpt-5.6-luna",
  [PI_DRIVER_KIND]: "openai-codex/gpt-5.6-luna",
};
