...
export const ThemePreference = Schema.Literals([
  "light",
  "dark",
  "midnight",
  "graphite",
...
export function readThemePreference(): Theme {
  ...
  if (Schema.is(ThemePreference)(raw)) return raw;
...
function applyTheme(theme: Theme, suppressTransitions = false) {
  ...
  const isDark = theme === "system" ? systemDark : theme !== "light";
  const resolvedPalette = theme === "system" ? (systemDark ? "dark" : "light") : theme;
  document.documentElement.classList.toggle("dark", isDark);
  document.documentElement.setAttribute("data-theme", resolvedPalette);
...
export function resolveDesktopTheme(theme: Theme): DesktopTheme {
  return theme === "system" || theme === "light" || theme === "dark" ? theme : "dark";
}
