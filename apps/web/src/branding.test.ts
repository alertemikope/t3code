...
describe("branding", () => {
  it("uses injected desktop branding when available", async () => {
    ...
    expect(branding.APP_BASE_NAME).toBe("MiCode");
    expect(branding.APP_STAGE_LABEL).toBe("Nightly");
    expect(branding.APP_DISPLAY_NAME).toBe("MiCode (Nightly)");
  });
  ...
  it("does not label the latest hosted app channel", async () => {
    ...
    expect(branding.APP_DISPLAY_NAME).toBe("MiCode");
  });
