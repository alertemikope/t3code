      ...
      const shouldApplyThreadLifecycle = (() => {
        ...
        switch (event.type) {
          ...
          case "turn.aborted":
            ...
            // Only the active turn may close the lifecycle state. Providers
            // emit turn.aborted for user interrupts and superseded turns, so
            // it must obey the same stale-event guard as turn.completed.
